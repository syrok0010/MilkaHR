    ...
    public async Task TrySeedAsync()
    {
        ...
        var jobs = new List<Job>
        {
            ...
            new Job
            {
                ...
                Recruiter = recruiter.Entity,
                CandidateStatuses = [],
                Category = JobCategory.Jurisprudence,
        ...
        var rand = new Bogus.DataSets.Address();
        string[] education = ["Высшее (бакалавриат)", "Среднее профессиональное", "Высшее (магистратура)"];
        var candidatesGenerator = new Faker<Candidate>("ru")
            ...
            .RuleFor(x => x.Education, f => education[f.Random.Number(education.Length - 1)])
            .RuleFor(x => x.BirthDate, f => f.Person.DateOfBirth.ToUniversalTime())
            .RuleFor(x => x.Email, (f, u) => f.Internet.Email(u.Name, u.LastName))
            .RuleFor(x => x.WorkExperience, (f, u) => f.Random.Number(10))
            .RuleFor(x => x.Phone, (f, u) => "+7" + f.Phone.PhoneNumber())
            .RuleFor(x => x.LastJob, (f, u) => "ИП \"" + f.Company.CompanyName() + '"')
            .RuleFor(x => x.Tags, f => ["OOP", "ASPNET", "C#"])
            .RuleFor(x => x.Photo, f => "data:image/png;base64,"
);

        var candidates = candidatesGenerator.Generate(20);

        List<CandidateStatus> statuses =
        [
            CandidateStatus.CvApproved,
            CandidateStatus.CvCreated,
